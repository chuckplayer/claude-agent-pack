...
CONTAINS` is **whole-tag membership, not substring matching.** Verified against `AMWINSGST/ReFac`:
...
- Source playbook: `amwins-profac/docs/AI-Assisted-Feature-Delivery-Playbook.docx`
